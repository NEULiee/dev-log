...
Delegate 방식은 한 화면에서 여러 이벤트가 발생하고, 해당하는 객체의 데이터를 가져와야할 때 사용하는 것이 적합하고,  
Notification 방식은 한 이벤트에 대해 여러 곳에서 이벤트를 수신해야할 경우 사용하는 것이 적합합니다.


## 멀티 쓰레드로 동작하는 앱을 작성하고 싶을 때 고려할 수 있는 방식들을 설명하시오. 
- 어떤 작업을 글로벌 큐에 넣어야 할지 고려해야합니다.
- 글로벌 큐에 작업을 배치할 때 작업에 따라 QoS를 적절하게 사용해야합니다.
- 동기, 비동기를 명확하게 정의해야합니다.
